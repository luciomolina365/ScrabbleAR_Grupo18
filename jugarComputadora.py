...
def __juega_IA(dificultad, tablero, atril, primer_turno, configuracion):
    print("JUEGA LA MAQUINOLAAAAAAAAAAAAAAAAAAAAAAA")
    print("dificultadddddddddddddddddddd")
    print(dificultad)
    print("tablerooooooooooooooooooooooooo")
    print(tablero)
    print("atrillllllllllllllllllllll")
    print(atril)
    print("primer_turnooooooooooooooooooooooooooooooo")
    print(primer_turno)
    print("configuracion")
    print(configuracion)
